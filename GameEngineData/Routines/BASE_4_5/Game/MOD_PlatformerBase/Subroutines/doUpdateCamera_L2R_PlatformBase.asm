;;;NEW CAMERA HANDLER by SciNEStist - modified for 1 way scroll
...
checkSeamForMonsterPosition:
    ;; y is loaded before subroutine.
            ...
            ;;check if a monster is already loaded in that x position first
                LDX #$00
                monsterDupeCheck:
                LDA Object_x_hi,x ;compare x pos
                    CMP temp2
                    BNE +notdupe
                        LDA Object_type,x ; compare type
                        CMP tempD
                        BNE +notdupe
                            LDA Object_y_hi,x ; compare y pos
                            CMP temp1
                            BNE +notdupe
                            JMP +isdupe
                    +notdupe
