    ...
    ;; even though we'd continue to move. What we need to do is checkt o see if
    ;; the relevant dpad buttons are pressed.  If any buttons are pressed that
    ;; would counter the change to a stop action upon release, we need to skip
    ;; the change to stop action.
