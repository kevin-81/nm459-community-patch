...
NPC_HEIGHT = #$10   
    ...
    AND #%00000001
    BEQ +continue
        ;; we also check if text box is about to be drawn/currently drawing
        LDA textQueued
        AND #%00000011
        BEQ +skip
            JMP dontSkipNPCtext
    ...
    ;;   - #TEXT_FREE allows you to just write a label definition in the
    ;;     following argument, and as long as you're in the right bank, will
    ;;     draw it.
