;;;NEW CAMERA HANDLER by SciNEStist + Autoscroll by default
...
;; let's check if we're in a static screen
...
; Now we get the direction. If the left edge is checked, we go right. If the right edge is checked, we go left.
LDA ScreenFlags00
AND #%00010000
BNE +
