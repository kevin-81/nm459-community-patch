    ...
    ;; object, so they do not have to be checked redundantly.
        ...
        -objectCollisionLoop:
            ...
            BEQ notMonsterOrMonsterWeapon
                ...
                BEQ notPlayerForMonsterCollision
                    ...
                    BEQ notLethalResult
                        SwitchBank #$18
                            ;; This should affect the PLAYER, the OTHER object
                            ;; currently loaded in x.
                            JSR doHandleHurtPlayer
                        ReturnBank
                        JMP checkNextObjectCollision
                    notLethalResult:
                ...
                BEQ notPlayerWeaponForMonsterCollision
                    ...
                    BEQ notHarmfulToMonster
                        ...
                        ;; could also check tempB if you don't want a player weapon
                        ;; to "hurt" a monster weapon.
                        LDA tempA
                        AND #%00001000
