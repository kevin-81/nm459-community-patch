...
doAnimAction02:
    .include ROOT\Game\TimerEndScripts\repeat.asm
    RTS
...
doAnimAction07:
    .include ROOT\Game\TimerEndScripts\goToWarp.asm
    RTS
...
doAnimAction09:
    .include ROOT\Game\TimerEndScripts\goToContinue.asm
    RTS

doAnimAction10:
    .include ROOT\Game\TimerEndScripts\restartScreen.asm
    RTS
