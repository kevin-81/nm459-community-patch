doLoadScreenData:
    ...
    SwitchBank arg0_hold
        ...
        ;; Get screen speed from ScreenByte01
        AND #%00000011
        STA screenSpeed
        ;; Other ScreenByte01 things can be done here
        ...
        ;; Right now, this is being hard coded to use pacman style
        LDA #%00000000
...
GetScreenTriggerInfo:
    ...
    ;; We'll have to use the stack for any part of these routines that
    ;; might need X.
