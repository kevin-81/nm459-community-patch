...
doUpdateCamera:    
    ...
    STA tempD ;; will hold.  If this is changed by the end of the routine,
              ;; then we need to update anything that should change when our
              ;; camera has crossed the screen boundary, such as screenFlags.
    ...
    SwitchBank temp
        ...
        loop_LoadNametableMeta_column:
            ...
            BEQ +doneWithNtLoad
                ...
                ;; update the 16 bit position of the new place to push
                ;; tiles to.
                LDA temp2
                CLC
                ADC #$40
        ...
        ;; 23 = 00100011
        ;; 27 = 00100111
        ;; Do the last bit of scrollUpdateScreen and shift it twice to the left
        ;; then or it with 00100000 to get the high byte of the attribute update
        ;; table.
        ...
        ;; temp2 now represents the low byte of the pushes. Don't need a temp3
        ;; to keep track of pull position, because it will be 1 to 1.
        ...
        BNE +doUpdateOddCt
            ...
            ;; do update even CT to ct table 1
            doUpdateCtLoop:
                LDA temp1
                AND #%00000001
                BNE +oddCol
        ...
        +doUpdateOddCt:
            ...
            ;; do update odd ct to ct table 2
            doUpdateCtLoop2:
                LDA temp1
                AND #%00000001
                BNE +oddCol
