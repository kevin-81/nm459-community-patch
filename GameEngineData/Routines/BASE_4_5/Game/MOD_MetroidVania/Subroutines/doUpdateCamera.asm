...
+noHorizontalCameraUpdate:
    ;; Here we have cross the screen boundary. So if there is anything that
    ;; needs updating for scrolling, update it here.
...
+canUpdateScrollColumn2:
    ...
    SwitchBank temp
        ...
        ORA #%00100011
        STA temp1
        ;; temp1 is now the high byte of the attribute table update
